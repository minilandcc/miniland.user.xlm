...
const media = 'https://img.freepik.com/premium-photo/3d-rendering-futuristic-cyberpunk-city-with-blue-pink-light-trail_138734-808.jpg?w=996'
...
console.log(asset)
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="d-flex" style={{}}>
            ...
            <div
              className="rounded-xx back-color-wite px-2 pt-1"
      ...
      <div className="text-small mt-1 d-xl-block d-none text-color-lite mx-3">
        {asset?.item || "******"}
      </div>
    </>
  );
