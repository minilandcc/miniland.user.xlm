...
const base = 'https://ap-southeast-1.aws.data.mongodb-api.com/app/terano-assets-x-niaor/endpoint'
...
export default async (req, res) => {
  ...
  const datx = {
    data: req.body.data,
    srvc: process.env.NEXT_APP_WEBB_SITE_SRVC,
  };
  console.log ("DDDDDDDDDDDD",datx)
  var result
  try {
